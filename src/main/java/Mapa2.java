...
public class Mapa2 extends MapView{
    ...
    public static void main(String[] args) throws IOException {
        ...
        //final Mapa2 example = new Mapa2("test");
        //example.generateMarker(map.getCenter());

        OkHttpClient client = new OkHttpClient().newBuilder()
                .build();
        Request request = new Request.Builder()
                .url("https://maps.googleapis.com/maps/api/place/details/json?place_id=ChIJN1t_tDeuEmsRUsoyG83frY4&fields=name%2Crating%2Cformatted_phone_number&key=AIzaSyCbEDTDcWLtdwhfQcSpAi9ImaQX5bIBAsc")
                .method("GET", null)
                .build();
